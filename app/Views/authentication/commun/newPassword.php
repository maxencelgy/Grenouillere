...
<form action="" method="post">
    ...
    <span class="error">
        <?php if (!empty($validation->getErrors()['password'])) echo $validation->getErrors()['password'] ?>
    </span>
    <input type="password" name="password" placeholder="Saisir un mots de passe">

    <span class="error">
        <?php if (!empty($validation->getErrors()['password_confirmation'])) echo $validation->getErrors()['password_confirmation'] ?>
    </span>
