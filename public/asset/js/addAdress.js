                ...
                info.addEventListener('click',e => {
                    ...
                    <div class="children">
                        <div style='display: none' class="infos">
                            <input name='adress_company' class="adress_company">${adresse}</input>
                            <input name='city_company' class="city_company">${ville}</input>
                            <input name='postal_code_company' class="postal_code_company">${cp}</input>                        
                            <input name='x_company' class="x_company">${x}</input>
                            <input name='y_company' class="y_company">${y}</input>          
                        <div>
                    </div>                  
                    `
                })
